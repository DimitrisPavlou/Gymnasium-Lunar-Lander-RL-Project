...
#has mse loss on both per and random buffer
...
class DuelingDoubleDQNAgent :
    ...
    def learn_PER(self, indices, experiences, sampling_weights , gamma):
        ...
        #Q_expected = self.qnetwork_local(states).gather(1 , actions.type(torch.int64))
    ...
    def train_agent(self, env, n_episodes=2000, max_t=1000, eps_start=1.0, eps_end=0.01, eps_decay=0.995):
        ...
        torch.save(self.qnetwork_local.state_dict(), "checkpoint_dueling_ddqn.pth")
        return scores
