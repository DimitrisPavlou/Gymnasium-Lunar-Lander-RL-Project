...
class DoubleDQNAgent :
    ...
    def __init__(self, state_size, action_size, device, random_seed,hidden_sizes = [256, 128],batch_norm = False,per = False):
        # INPUT:
    ...
    def learn(self, experiences, gamma):
        ...
        #find the a_prime that maximizes Q
        Q_argmax = self.qnetwork_local(next_states).detach()
        _, a_prime = Q_argmax.max(1)
    ...
    def train_agent(self, env, n_episodes = 2000 , max_t = 500, eps_start=1.0, eps_end=0.01, eps_decay=0.995) :
        ...
        for i_episode in range(1, n_episodes+1):
            ...
            if np.mean(scores_window) >= 200.0:
                ...
                break
        #sava model after the end of training
        torch.save(self.qnetwork_local.state_dict(), "checkpoint_ddqn.pth")
        return scores
